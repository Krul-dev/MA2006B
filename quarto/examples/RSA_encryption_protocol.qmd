...
Mostramos ahora la llave privada que generamos. En la práctica, es muy importante que esta información no se divulgue.

```{python}
private_key
```

La llave pública, por otro lado, se debe de compartir con las partes interesadas, a fín de que puedan encriptar sus mensajes. En este caso la llave pública a compartir es:
